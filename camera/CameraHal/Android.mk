...
LOCAL_SHARED_LIBRARIES += \
    libstlport
endif # TARGET_BOARD_HARDWARE rk30board
...
LOCAL_SHARED_LIBRARIES += \
    ...
    libvpu \
    libdl
endif # TARGET_BOARD_HARDWARE rk2928board
...
LOCAL_SHARED_LIBRARIES += \
    ...
    libjpeg \
    libyuvtorgb
endif # TARGET_BOARD_HARDWARE rk29board

LOCAL_CPPFLAGS += -fpermissive

LOCAL_CFLAGS += -fno-short-enums -DCOPY_IMAGE_BUFFER
LOCAL_CFLAGS += -DLINUX -DMIPI_USE_CAMERIC -DHAL_MOCKUP \
    -DCAM_ENGINE_DRAW_DOM_ONLY -D_FILE_OFFSET_BITS=64 -DHAS_STDINT_H
