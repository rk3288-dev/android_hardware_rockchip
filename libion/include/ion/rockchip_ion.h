...
#ifndef _LIBION_ROCKCHIP_ION_H
#define _LIBION_ROCKCHIP_ION_H
 ...
 */
#define ION_IOC_GET_PHYS \
    _IOWR(ION_IOC_ROCKCHIP_MAGIC, 0, struct ion_phys_data)

/* Alloc secure region. */
#define ION_IOC_ALLOC_SECURE \
    _IOWR(ION_IOC_ROCKCHIP_MAGIC, 1, struct ion_phys_data)

/* Free secure region alloced. */
#define ION_IOC_FREE_SECURE \
    _IOWR(ION_IOC_ROCKCHIP_MAGIC, 2, struct ion_phys_data)
